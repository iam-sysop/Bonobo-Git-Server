using gitserverdotnet.App_Start;
using gitserverdotnet.Attributes;
using gitserverdotnet.Configuration;
using gitserverdotnet.Controllers;
using gitserverdotnet.Data;
using gitserverdotnet.Data.Update;
using gitserverdotnet.Git;
using gitserverdotnet.Git.GitService;
using gitserverdotnet.Git.GitService.ReceivePackHook;
using gitserverdotnet.Git.GitService.ReceivePackHook.Durability;
using gitserverdotnet.Git.GitService.ReceivePackHook.Hooks;
...
namespace gitserverdotnet
{
    public class MvcApplication : HttpApplication
    {
        ...
        {
            ConfigureLogging();
            Log.Information("gitserver.net starting");
            ...
            var connectionstring = WebConfigurationManager.ConnectionStrings["gitserverdotnetContext"];
