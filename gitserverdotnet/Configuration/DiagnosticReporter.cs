...
{
    /// <summary>
    /// This class can produce a textual diagnostic report of gitserver.net's configuration
    ...
    public class DiagnosticReporter
    {
        ...
        private void CheckInternalMembership()
        {
            ...
            {
                SafelyReport("User count", () => new EFMembershipService { CreateContext = () => new gitserverdotnetContext() }.GetAllUsers().Count);
            }
            else
            {
                Report("Not Enabled");
