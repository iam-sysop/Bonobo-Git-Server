...
namespace gitserverdotnet.Git.GitService.ReceivePackHook.Hooks
{
    public class AuditPusherToGitNotes : IHookReceivePack
    {
        ...
        private gitserverdotnet.Data.IRepositoryRepository repoConfig;
        private readonly IMembershipService userRepo;

        public AuditPusherToGitNotes(IHookReceivePack next, IGitRepositoryLocator repoLocator, gitserverdotnet.Data.IRepositoryRepository repoConfig, IMembershipService userRepo)
        {
            this.next = next;
