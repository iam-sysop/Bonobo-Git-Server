...
namespace gitserverdotnet.Data
{
    ...
    {
        [Dependency]
        public Func<gitserverdotnetContext> CreateContext { get; set; }
        ...
        private void AddMembers(IEnumerable<Guid> users, IEnumerable<Guid> admins, IEnumerable<Guid> teams, Repository repo, gitserverdotnetContext database)
        {
            if (admins != null)
            {
