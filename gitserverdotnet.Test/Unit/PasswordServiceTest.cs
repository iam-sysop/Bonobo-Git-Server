...
namespace gitserverdotnet.Test.Unit
{
    [TestClass]
    public class PasswordServiceTest
    {
        ...
        {
            var script = new gitserverdotnet.Data.Update.Sqlite.InsertDefaultData();
        ...
        {
            var script = new gitserverdotnet.Data.Update.SqlServer.InsertDefaultData();
            AssertSaltedSha512HashIsUsed(script);
        }
