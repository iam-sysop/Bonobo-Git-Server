...
using gitserverdotnet.Test.IntegrationTests;
using gitserverdotnet.Test.IntegrationTests.Helpers;
...
namespace gitserverdotnet.Test.Integration.ClAndWeb
{
    ...
    public class MsysgitIntegrationTests
    {
        ...
        private readonly static string ServerRepositoryPath = Path.Combine(@"..\..\..\gitserverdotnet\App_Data\Repositories", RepositoryName);
