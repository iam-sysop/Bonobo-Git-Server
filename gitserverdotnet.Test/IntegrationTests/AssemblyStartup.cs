...
namespace gitserverdotnet.Test.IntegrationTests
{
    [TestClass]
    public class AssemblyStartup
    {
        ...
        static public void AssemblyInit(TestContext tc)
        {
            ...
            config.UseIISExpress()
                ...
                .With(Project.Named("gitserverdotnet"))
                .UsePort(20000)
            ...
            config.BuildRoutesUsing(r => gitserverdotnet.App_Start.RouteConfig.RegisterRoutes(r));
