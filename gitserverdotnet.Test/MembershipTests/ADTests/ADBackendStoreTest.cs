...
namespace gitserverdotnet.Test.MembershipTests.ADTests
{
    ...
    public class ADBackendStoreTest
    {
        ...
        {
            _testDirectory = Path.Combine(Path.GetTempPath(), "gitserverdotnetTestStore");
        ...
        {
            return new ADBackendStore<StorableClass>(Path.GetTempPath(), "gitserverdotnetTestStore");
        }
